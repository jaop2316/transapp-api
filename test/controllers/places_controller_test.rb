...
class PlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create place" do
    assert_difference('Place.count') do
      post places_url, params: { place: { category_id: @place.category_id, name: @place.name } }
    end
  ...
  test "should update place" do
    patch place_url(@place), params: { place: { category_id: @place.category_id, name: @place.name } }
